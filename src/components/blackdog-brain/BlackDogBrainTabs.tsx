...
export function BlackDogBrainTabs() {
  ...
  return (
    <div className="page-shell pt-6">
      <nav className="scroll-x-panel mx-auto flex w-fit max-w-full flex-nowrap items-center gap-2 rounded-full border border-[#dfd6c8] bg-white/82 p-1 shadow-[0_16px_36px_rgba(31,41,51,0.08)] backdrop-blur">
