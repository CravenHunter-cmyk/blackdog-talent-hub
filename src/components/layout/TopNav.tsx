...
const navItems = [
  ...
  { label: "Delivery Hub", href: "/work-center" },
...
export function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#e2d8c8] bg-[#fbfaf6]/96 shadow-[0_8px_20px_rgba(31,41,51,0.05)] backdrop-blur">
      <div className="mx-auto flex h-[72px] max-w-[1460px] flex-nowrap items-center gap-4 px-5 pl-[clamp(48px,5vw,88px)]">
        <div className="mr-10 w-[210px] shrink-0">
        ...
        <nav className="ml-auto flex min-w-0 -translate-x-28 flex-nowrap items-center justify-end gap-1">
          {navItems.map((item) => (
            <Link
              key={item.label}
              href={item.href}
